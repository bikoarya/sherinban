     ...
     <section class="content">
         <div class="row">
             <div class="col-12">
                 <div class="card">
                     <div class="card-body">
                         <form action="<?= base_url('lapreturpengembalian/cetak'); ?>" method="POST">
                                 ...
                                 <div class="input-group">
                                     ...
                                     <div style="margin-left: 10px">
                                         <select name="keys" id="pilih" class="form-control kategori" data-place="Cari Berdasarkan" style="width: 100%;">
                                             <option value=""></option>
                                             <option value="no_notapembelian">No Faktur</option>
                                             <option value="nama_barang">Nama Barang</option>
                                             <option value="spek">Spesifikasi</option>
                                             <option value="kode_produksi">Kode Produksi</option>
                                         </select>
                                     </div>
                                     <div>
                             ...
                             <div class="table-responsive">
                                 <table id="laporan" class="laporantable table table-bordered" data-link="<?= base_url('lapreturpengembalian/getdata'); ?>">
                                     <thead>
                                         <tr>
                                             <th>#</th>
                                             <th>Tanggal Retur</th>
